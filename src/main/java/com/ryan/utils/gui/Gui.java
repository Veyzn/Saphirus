...
import com.ryan.utils.gui.events.GuiCloseEvent;
...
public class Gui {
    ...
    public void openInventory( Player player ) {
        gui = Bukkit.createInventory( null, 9 * size, MsgUtils.colored( name ) );
        ...
        RMain.PLUGIN.getServer().getPluginManager().registerEvents( listener, RMain.PLUGIN );
    }
}